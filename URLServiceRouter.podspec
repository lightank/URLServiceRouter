#
#  Be sure to run `pod spec lint URLServiceRouter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "lightank" => "1303908401@qq.com" }
  # Or just: spec.author    = "lightank"
  # spec.authors            = { "lightank" => "1303908401@qq.com" }
  ...
  spec.source       = { :git => "https://github.com/lightank/URLServiceRouter.git", :tag => "#{spec.version}" }
